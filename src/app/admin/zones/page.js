...
export default function AdminZones() {
  ...
  async function deleteZone(id) {
    ...
    try {
      // DELETE ALL GAMES
      // DELETE ALL GAMES BELONGING TO THIS ZONE
      ...
      // DELETE ALL MENU / CAFE ITEMS
      const menuSnapshot = await getDocs(collection(db, "zones", id, "menu"));

      for (const menuDoc of menuSnapshot.docs) {
        await deleteDoc(doc(db, "zones", id, "menu", menuDoc.id));
      }
      ...
      toast.success("Zone and all related data deleted successfully");
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-slate-800 p-6 rounded-lg border border-slate-700">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-slate-400 text-sm">Active Zones</p>
          ...
          <div className="bg-slate-800 p-6 rounded-lg border border-slate-700 mb-8">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="hasCafe" className="text-slate-300">
                  Has Cafe
                </label>
              </div>
