...
import { FaPlus, FaTrash, FaUtensils, FaMapMarkerAlt, FaDollarSign, FaTag } from "react-icons/fa"
      ...
      <div className="flex-1 p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-slate-800 p-6 rounded-lg border border-slate-700 mb-8">
            <h2 className="text-xl font-semibold text-slate-100 mb-6">Add New Menu Item</h2>
            {errors.submit && (
          ...
          <div className="bg-slate-800 rounded-lg border border-slate-700 overflow-hidden">
            <div className="p-6 border-b border-slate-700">
              <h2 className="text-xl font-semibold text-slate-100">All Menu Items</h2>
            </div>
